...
(New-Object System.Net.WebClient).DownloadFile('https://softwareupdate.vmware.com/cds/vmw-desktop/fusion/11.1.0/13668589/packages/com.vmware.fusion.tools.windows.zip.tar', 'C:\Windows\Temp\vmware-tools.zip.tar')
